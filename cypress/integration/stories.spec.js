describe('Stories', () => {
  ...
  it('displays badges when earned', () => {
    ...
    cy.location().then((loc) => {
      cy.visit(loc.pathname + '?storyNode=optional_priveledge_and_adjustment_reconciliation_form')
    }).contains('Yes').click();
    cy.contains('You whined, and it felt good', {timeout: 3000}).should('exist');
  });
