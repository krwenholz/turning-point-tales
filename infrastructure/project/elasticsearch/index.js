    ...
    post(elasticsearchBulkData, function(
      ...
      if (error) {
        ...
        if (failedItems && failedItems.length > 0) {
          ...
          console.log("bbbbb " + JSON.stringify(elasticsearchBulkData));
        }
...
function transform(payload) {
  ...
  payload.logEvents.forEach(function(logEvent) {
    ...
    let pipeline;
    if (logEvent.message.includes("REQUEST_LOG")) pipeline = "weblog";
    else pipeline = "json_log";
    var indexName = [
      "cwl-" + pipeline + timestamp.getUTCFullYear(), // year
